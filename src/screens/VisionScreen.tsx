...
export const VisionScreen: React.FC = () => {
  ...
  usePracticeNotificationGuard(isPlaying, VISION_DURATION_MIN);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.7}>Clear Seeing</Text>
